...
def kallisto():
    ...
    subprocess.run(f"kallisto index -i transcripts.idx matches.fasta", shell=True)
    subprocess.run(f"kallisto quant -i transcripts.idx -o output -b 100 {forwreads} {revreads}", shell=True)
